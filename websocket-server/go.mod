module github.com/JoTaeYang/go-cook/websocket-server

go 1.18

require (
	github.com/JoTaeYang/go-cook/common v0.0.0-20231029091010-af5ff4f87f62
...
replace github.com/JoTaeYang/go-cook/common => ../common
